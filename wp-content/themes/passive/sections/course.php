  ...
  <div class="container">
    ...
    <div class="course-items">
      <div class="item">
        ...
        <div class="text">
          <h4>Ťažba kryptomien</h4>
          <p>Ako si vybudovať pasívny príjem od A-Z pomocou ťažby kryptomien.</p>
          <div class="stats p-bottom-large">
            <span class="push-right "><i class="fas fa-clock"></i> 3 hodiny</span>
            <span class="push-right "><i class="fas fa-video"></i> 21 videi</span>
